...
class Keluhan extends BaseController
{
    ...
    {
        // get data keluhan
        $data_keluhan = $this->keluhanModel->where('created', $kode_karyawan)->findAll();
        $data = [
            'tittle' => 'Data Keluhan',
            'data_keluhan' => $data_keluhan
        ];
    ...
    public function approve($id_keluhan)
    {
        ...
        $id = $data_keluhan = $this->keluhanModel->where('kode_keluhan', $id_keluhan)->first();
        ...
        return redirect()->to(base_url('/admin/data-keluhan'));
    }
    ...
    public function delete_keluhan($id_keluhan)
    {
        ...
        $foto = $id['foto'];
        // unlink foto
        unlink('data/foto keluhan/' . $foto);

        // hapus keluhan
        $this->keluhanModel->delete($id['id']);
        session()->setFlashdata('pesan', 'Data Keluhan Berhasil di Hapus!');
        return redirect()->to(base_url('/admin/data-keluhan'))->withInput();
    }
    ...
    public function proses_input()
    {
        ...
        if (!$this->validate([
            ...
            return redirect()->to(base_url('/admin/buat-keluhan'))->withInput();
        } else {
            // ambil files
            ...
            $this->keluhanModel->save([
                'kode_keluhan' => $this->request->getVar('id_keluhan'),
                'tanggal_create' => $tanggal,
                'tanggal_update' => 'Not Updated!',
                'subject' => $this->request->getVar('subject_keluhan'),
                'detail_keluhan' => $this->request->getVar('detail_keluhan'),
            ...
            session()->setFlashdata('pesan', 'Input Keluhan Berhasil!');
            return redirect()->to(base_url('/admin/buat-keluhan'));
        }
    }
    ...
    public function proses_input2()
    {
        ...
        if (!$this->validate([
            ...
            session()->setFlashdata('pesan', 'Input Keluhan Berhasil!');
            return redirect()->to(base_url('/views/buat-keluhan'));
        }
    }


    public function detail_keluhan($id_keluhan)
    {
        // get data keluhan
        $data_keluhan = $this->keluhanModel->where('kode_keluhan', $id_keluhan)->first();
        // get kode user
        ...
        $data = [
            'tittle' => 'Detail Keluhan',
            'data_keluhan' => $data_keluhan,
            'nama' => $nama
        ];
        return view('Keluhan/detail', $data);
    }
