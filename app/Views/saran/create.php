                        ...
                        <div class="card">
                            <div class="card-body">
                                <?php if (session('level') == 'admin') : ?>
                                    <form action="<?= base_url(); ?>/saran/proses_input" method="post" enctype="multipart/form-data">
                                    <?php endif; ?>

                                    <?php if (session('level') == 'karyawan') : ?>
                                        <form action="<?= base_url(); ?>/saran/proses_input2" method="post" enctype="multipart/form-data">
                                        <?php endif; ?>
                                        <?= csrf_field() ?>
                                        <div class="form-group row">
                                            <label for="colFormLabelSm" class="col-sm-2 col-form-label col-form-label">ID Saran</label>
                                            <div class="col-md-3">
                                        ...
                                        <div class="form-group row">
                                            <label for="colFormLabelSm" class="col-sm-2 col-form-label col-form-label">Subject Saran</label>
                                            <div class="col-md-9">
                                        ...
                                        <div class="form-group row">
                                            <label for="colFormLabelSm" class="col-sm-2 col-form-label col-form-label">Detail Saran</label>
                                            <div class="col-md-9">
