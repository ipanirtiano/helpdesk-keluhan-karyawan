            ...
            <div class="col">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-envelope-open mr-2" aria-hidden="true"></i> Detail Saran
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-header bg-info text-white">
                                        <i class="fa  fa-sticky-note mr-2" aria-hidden="true"></i> ID Keluhan : <?= $data_keluhan['kode_saran']; ?>
                                    </div>
                                    <div class="card-body">
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item"> <i class="fa fa-list-ul mr-3" aria-hidden="true"></i> <b><?= $data_keluhan['kode_saran']; ?></b> </li>
                                            ...
                                            <li class="list-group-item"><i class="fa fa-briefcase mr-3" aria-hidden="true"></i> <b>Detail Keluhan</b>
                                                <div class="form-floating mt-3">
                                                    <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" readonly><?= $data_keluhan['detail_saran']; ?>
                                            </textarea>
                                                </div>
                                            </li>
                                        ...
                                        <?php if (session('level') == 'admin') : ?>
                                            <form action="<?= base_url(); ?>/saran/update_progres/<?= $data_keluhan['kode_saran']; ?>" method="POST">
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <center><img src="<?= base_url(); ?>/data/foto saran/<?= $data_keluhan['foto']; ?>" alt="" width="500px"></center>
                                        <br>


                                        <?php if (session('level') == 'admin') : ?>
                                            <form action="<?= base_url(); ?>/keluhan/update_foto/<?= $data_keluhan['kode_saran']; ?>" method="POST" enctype="multipart/form-data">
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3">
